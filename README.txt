aarch64--glibc--bleeding-edge-2018.07-3
...
For those who would like to reproduce the toolchain, you can just follow these steps:
    ...
    curl http://toolchains.bootlin.com/downloads/releases/toolchains/aarch64/build_fragments/aarch64--glibc--bleeding-edge-2018.07-3.defconfig > .config
    make olddefconfig
    make
